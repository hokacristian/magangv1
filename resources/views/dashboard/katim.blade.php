...
<body class="bg-gray-100 font-sans leading-normal tracking-normal">
  ...
  <nav class="bg-blue-600 p-4 shadow-lg">
    <div class="container mx-auto flex justify-between items-center">
        <h1 class="text-white text-2xl font-bold">Dashboard Katim</h1>
        <div class="relative">
    ...
    <div class="container mx-auto mt-8">
        ...
        <div class="bg-white shadow-md rounded-lg p-6 mb-6">
            <h2 class="text-xl font-bold mb-4">Selamat Datang, Katim!</h2>
            <p class="text-gray-700 mb-6">Ini adalah halaman dashboard untuk Katim. Pilih bulan untuk melihat laporan rekonsiliasi saldo BLU.</p>

            <!-- Form Pilih Bulan -->
            <form action="{{ route('katim.rekonsiliasi') }}" method="POST" target="_blank" class="space-y-4">
                @csrf
                <div>
        ...
        <!-- Filter Bulan -->
        <div class="mb-6">
            <form method="GET" action="{{ route('katim.dashboard') }}" onsubmit="showLoader()" class="flex flex-col md:flex-row items-start md:items-center space-y-4 md:space-y-0 md:space-x-4">
                <div >
                    <label for="bulan" class="block text-sm font-medium text-gray-700">Pilih Bulan:</label>
