...
<div class="bg-white shadow-md rounded-lg p-6 mb-6">
    ...
    <p class="text-gray-700 mb-6">Ini adalah halaman dashboard untuk Katim. Pilih bulan dan tahun untuk melihat laporan rekonsiliasi saldo BLU.</p>
...
<script>
    ...
    function loadTransaksiDetail() {
        ...
        $.ajax({
            url: "{{ route('katim.getTransaksiDetail') }}",
            method: "GET",
